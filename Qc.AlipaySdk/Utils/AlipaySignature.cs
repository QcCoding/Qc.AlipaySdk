...
namespace Qc.AlipaySdk.Utils
{
    /// <summary>
    /// 支付宝签名
    /// </summary>
    /// <remarks>
    /// 摘自：https://github.com/dotnetcore/Alipay.AopSdk.Core/blob/master/Alipay.AopSdk.Core/Util/AlipaySignature.cs
    /// hash：cf0a6005812f1cf656df1b0655a2b733ac6b530a
    /// </remarks>
    public class AlipaySignature
    {
        ...
        public static string GetSignContent(IDictionary<string, string> parameters)
        {
            ...
            var content = query.ToString().TrimEnd('&');
            ...
            string signType)
        {
            ...
            {
                throw new Exception($"您使用的私钥格式错误，请检查RSA私钥配置,charset = {charset},异常信息:{ex.Message}", ex);
            }
            return Convert.ToBase64String(signatureBytes);
        }
        ...
        public static RSA LoadCertificateString(string strKey, string signType)
        {
            ...
            {
                throw new Exception("Alipay.AopSdk.Core.Util.AlipaySignature LoadCertificateString DecodeRSAPrivateKey Error", ex);
            }
            return null;
        }
